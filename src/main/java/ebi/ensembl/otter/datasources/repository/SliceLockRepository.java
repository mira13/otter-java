...
public interface SliceLockRepository
	...
	@Query(value="select slice_lock.* "
			...
			nativeQuery = true)
	public List<SliceLock> getLocksByCoordSystemAndName(@Param("csname") String csname, @Param("csversion") String csversion, @Param("name") String name);
